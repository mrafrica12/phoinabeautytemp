...
const PB_CMS = (() => {
    ...
    events: [
      {
        ...
        whatsappLink: 'https://wa.me/16784380539?text=Bridal+Masterclass+Registration',
      ...
      },
      {
        ...
        whatsappLink: 'https://wa.me/16784380539?text=Hair+Expo+RSVP',
      ...
      },
      {
        ...
        whatsappLink: 'https://wa.me/16784380539?text=Academy+July+Enrollment',
  ...
  function renderProductCard(product) {
    ...
    const waLink  = `https://wa.me/16784380539?text=I+want+to+buy+${encodeURIComponent(product.name)}`;
  ...
  function renderServiceCard(service, delay = '') {
    ...
    const waPhone = (window.PB_SETTINGS && window.PB_SETTINGS.whatsapp) || '16784380539';
    return `
